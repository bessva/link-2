...
DIALOG_STEPS: list[dict] = [
    ...
    },
    {
        ...
        "type":     "float",
        "hint":     "Типичное значение: 280–360 г/кВт·ч",
        "default":  320.0,
    },
    {
        "key":      "b_te",
    ...
    # ── 4а. Режим выживания — только для ≥25 МВт ─────────
    {
        ...
        "hint":     "По Правилам технологического функционирования электроэнергетических систем",
    },
    {
        "key":      "E_sn_day",
    ...
    # ── 5. Максимальные параметры (≥25 МВт) ──────────────
    {
        ...
        "type":     "float",
        "condition": lambda p: p.get("category") == "large",
        "hint":     "По Правилам технологического функционирования",
    },
    {
        "key":      "E_sn_maks",
    ...
    # ── 6а. Надёжность поставки (≥25 МВт, не трубопровод) ─
    {
        ...
        "hint":     "Считается по формуле Т = Σ(Тi×Vi)/Σ(Vi)",
    },
    {
    ...
    },
    {
        ...
        "hint":     "КИУМт = Qтс_план / (Qтс_уст × nмес) × 100%",
    },
    {
        ...
        "hint":     "Pмин.доп — из зимнего контрольного замера Системного оператора",
    },
